...
class Window(Tk):
    def __init__(self):
        ...
        Label(self, text='PDF to Audio and Audio to PDF converter', wraplength=400,
              bg='aqua', font=("Comic Sans MS", 20)).place(x=220, y=30)

        Button(self, text="Convert PDF to Audio", font=("Comic Sans MS", 15), bg='Tomato',
               command=self.pdf_to_audio, width=25).place(x=300, y=300)

        Button(self, text="Convert Audio to PDF", font=("Comic Sans MS", 15), bg='Tomato',
               command=self.audio_to_pdf, width=25).place(x=300, y=400)
